...
#  Generated on:      Tue Jun 30 00:50:41 2026
#  Design:            ALU
#  Command:           create_ccopt_clock_tree_spec -file pd_scripts/ccopt_alu.spec -keep_all_sdc_clocks -views view1
###############################################################
#-------------------------------------------------------------------------------
...
#   clk (period 8.000ns) in timing_config sdc1([/home/arpit23132/Desktop/RTL_to_GDS_ALU/pd_snapshots/alu_placement_05.enc.dat/libs/mmmc/dft_constraints_balanced.sdc])
create_ccopt_clock_tree -name clk -source clk -no_skew_group
set_ccopt_property target_max_trans_sdc -delay_corner delay1 -early -clock_tree clk 0.400

set_ccopt_property target_max_trans_sdc -delay_corner delay1 -late -clock_tree clk 0.400
# Clock period setting for source pin of clk
set_ccopt_property clock_period -pin clk 8

# Skew group to balance non generated clock:clk in timing_config:sdc1 (sdc /home/arpit23132/Desktop/RTL_to_GDS_ALU/pd_snapshots/alu_placement_05.enc.dat/libs/mmmc/dft_constraints_balanced.sdc)
