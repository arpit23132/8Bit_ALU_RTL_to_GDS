...
set log file lec_outputs/bad_cases/lec_bad1_missing_ff.log -replace

read library lib/slow.v -verilog -both

read design rtl/ALU.v -verilog -golden
read design lec_bad_netlists/bad1_missing_ff.v -verilog -revised
...
set verification information lec_outputs/bad_cases/Equivalence_checking_bad1
