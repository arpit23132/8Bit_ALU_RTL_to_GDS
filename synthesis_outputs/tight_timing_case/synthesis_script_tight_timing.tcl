...
set_db -quiet runtime_by_stage {{PBS_Generic-Start 0 15 0.0 6.0} {to_generic 2 17 1 7} {first_condense 10 27 12 20} {PBS_Generic_Opt-Post 12 27 11.610700999999999 17.610701} {{PBS_Generic-Postgen HBO Optimizations} 0 27 0.0 17.610701} {PBS_TechMap-Start 0 28 0.0 17.610701} {{PBS_TechMap-Premap HBO Optimizations} 0 28 0.0 17.610701} {second_condense 10 38 14 35} {reify 10 48 19 54} {global_incr_map 1 49 1 55} {{PBS_Techmap-Global Mapping} 21 49 21.656450999999997 39.267151999999996} {{PBS_TechMap-Datapath Postmap Operations} 1 50 -0.020948000000004185 39.24620399999999} {{PBS_TechMap-Postmap HBO Optimizations} 0 50 -0.017685000000000173 39.22851899999999} {{PBS_TechMap-Postmap Clock Gating} 0 50 0.0 39.22851899999999} {{PBS_TechMap-Postmap Cleanup} 0 50 0.976586999999995 40.20510599999999} {PBS_Techmap-Post_MBCI 0 50 0.0 40.20510599999999}}
set_db -quiet tinfo_tstamp_file .rs_arpit23132.tstamp
set_db -quiet metric_enable true
set_db -quiet flow_metrics_snapshot_uuid c84b2e72-f5aa-43a8-b78f-c299ae651655
...
# BEGIN MSV SECTION
# END MSV SECTION
define_clock -name clk -domain domain_1 -period 4000.0 -divide_period 1 -rise 0 -divide_rise 1 -fall 1 -divide_fall 2 -remove -design design:ALU port:ALU/clk
...
set_db -quiet design:ALU .qos_by_stage {{to_generic {wns -11111111} {tns -111111111} {vep -111111111} {area 16032} {cell_count 1961} {utilization  0.00} {runtime 2 17 1 7} }{first_condense {wns -11111111} {tns -111111111} {vep -111111111} {area 15376} {cell_count 1929} {utilization  0.00} {runtime 10 27 12 20} }{second_condense {wns -11111111} {tns -111111111} {vep -111111111} {area 15700} {cell_count 1971} {utilization  0.00} {runtime 10 38 14 35} }{reify {wns 30} {tns 0} {vep 0} {area 6752} {cell_count 1255} {utilization  0.00} {runtime 10 48 19 54} }{global_incr_map {wns 40} {tns 0} {vep 0} {area 6324} {cell_count 1146} {utilization  0.00} {runtime 1 49 1 55} }}
...
## Written on 02:36:58 29-Jun 2026
#############################################################
#####   Flow Definitions   ##################################
...
if {[is_attribute flow_metrics_snapshot_uuid -obj_type root]} {set_db flow_metrics_snapshot_uuid c84b2e72-f5aa-43a8-b78f-c299ae651655}
