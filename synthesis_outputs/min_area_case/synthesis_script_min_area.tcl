...
# Created by Genus(TM) Synthesis Solution 19.13-s073_1 on Mon Jun 29 02:16:45 IST 2026
...
set_db -quiet runtime_by_stage {{PBS_Generic-Start 0 11 0.0 6.0} {to_generic 1 12 1 7} {first_condense 2 14 3 11} {PBS_Generic_Opt-Post 3 14 3.290215 9.290215} {{PBS_Generic-Postgen HBO Optimizations} 0 15 0.0 9.290215} {PBS_TechMap-Start 0 15 0.0 9.290215} {{PBS_TechMap-Premap HBO Optimizations} 0 15 0.0 9.290215} {second_condense 2 17 3 14} {reify 4 21 8 23} {global_incr_map 0 21 0 23} {{PBS_Techmap-Global Mapping} 6 21 6.4145189999999985 15.704733999999998} {{PBS_TechMap-Datapath Postmap Operations} 0 22 0.989456999999998 16.694190999999996} {{PBS_TechMap-Postmap HBO Optimizations} 0 22 -0.010431999999997998 16.683759} {{PBS_TechMap-Postmap Clock Gating} 0 22 0.0 16.683759} {{PBS_TechMap-Postmap Cleanup} 0 22 -0.007863000000000397 16.675895999999998} {PBS_Techmap-Post_MBCI 0 22 0.0 16.675895999999998}}
set_db -quiet tinfo_tstamp_file .rs_arpit23132.tstamp
set_db -quiet metric_enable true
set_db -quiet flow_metrics_snapshot_uuid 978112fd-49e5-491e-be25-199811ffab17
...
# BEGIN MSV SECTION
# END MSV SECTION
define_clock -name clk -domain domain_1 -period 15000.0 -divide_period 1 -rise 0 -divide_rise 1 -fall 1 -divide_fall 2 -remove -design design:ALU port:ALU/clk
...
set_db -quiet design:ALU .qos_by_stage {{to_generic {wns -11111111} {tns -111111111} {vep -111111111} {area 12340} {cell_count 1454} {utilization  0.00} {runtime 1 12 1 7} }{first_condense {wns -11111111} {tns -111111111} {vep -111111111} {area 12191} {cell_count 1512} {utilization  0.00} {runtime 2 14 3 11} }{second_condense {wns -11111111} {tns -111111111} {vep -111111111} {area 12054} {cell_count 1494} {utilization  0.00} {runtime 2 17 3 14} }{reify {wns 2063} {tns 0} {vep 0} {area 3830} {cell_count 480} {utilization  0.00} {runtime 4 21 8 23} }{global_incr_map {wns 1825} {tns 0} {vep 0} {area 3745} {cell_count 450} {utilization  0.00} {runtime 0 21 0 23} }}
...
## Written on 02:16:45 29-Jun 2026
#############################################################
#####   Flow Definitions   ##################################
...
if {[is_attribute flow_metrics_snapshot_uuid -obj_type root]} {set_db flow_metrics_snapshot_uuid 978112fd-49e5-491e-be25-199811ffab17}
